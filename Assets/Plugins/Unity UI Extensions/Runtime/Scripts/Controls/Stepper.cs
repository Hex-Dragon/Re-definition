...
namespace UnityEngine.UI.Extensions
{
    ...
    public class Stepper : UIBehaviour
    {
        ...
        public int value { get { return _value; } set { _value = value; DisableAtExtremes(sides); } }

        public int minimum { get { return _minimum; } set { _minimum = value; DisableAtExtremes(sides); } }

        public int maximum { get { return _maximum; } set { _maximum = value; DisableAtExtremes(sides); } }
