...
namespace UnityEngine.UI.Extensions
{
    ...
    public class UIWindowBase : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler
    {
        ...
        public void OnBeginDrag(PointerEventData eventData) {
            ...
            _isDragging = true;
            /*
             * 不知道为啥，这个事件有延迟的，如果你鼠标动太快移动出去了，原本的修复会导致你拖不动
            ...
            Debug.Log(eventData.pointerCurrentRaycast.gameObject == null ? "null" : eventData.pointerCurrentRaycast.gameObject.name);
